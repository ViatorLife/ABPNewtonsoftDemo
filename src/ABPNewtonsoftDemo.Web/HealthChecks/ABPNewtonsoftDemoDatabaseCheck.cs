...
public class ABPNewtonsoftDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ABPNewtonsoftDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
