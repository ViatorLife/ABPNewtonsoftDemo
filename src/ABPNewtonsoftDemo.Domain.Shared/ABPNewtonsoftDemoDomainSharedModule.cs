...
public class ABPNewtonsoftDemoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ABPNewtonsoftDemoGlobalFeatureConfigurator.Configure();
        ABPNewtonsoftDemoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ABPNewtonsoftDemoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ABPNewtonsoftDemoResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ABPNewtonsoftDemo");

            options.DefaultResourceType = typeof(ABPNewtonsoftDemoResource);
        ...
        {
            options.MapCodeNamespace("ABPNewtonsoftDemo", typeof(ABPNewtonsoftDemoResource));
        });
    }
}
